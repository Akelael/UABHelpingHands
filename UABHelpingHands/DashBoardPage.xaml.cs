...
namespace UABHelpingHands
{
    ...
    /// </summary>
    public sealed partial class DashBoardPage : UABHelpingHands.Common.LayoutAwarePage
    {
        ...
        void Header_Click(object sender, RoutedEventArgs e)
        {
            ...
            //this.Frame.Navigate(typeof(CandidatePage), ((SampleDataGroup)group).UniqueId);
        }
        ...
        void ItemView_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            this.Frame.Navigate(typeof(CandidatePage), itemId);
        }

        private void OnKeyDown(object sender, TappedRoutedEventArgs e)
        {
